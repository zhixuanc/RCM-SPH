...
\end{equation}
where the superscript $REF$ represent the reference solution, $SPH$ represents simulation results calculated by different SPH schemes. Fig. \ref{fig:Accuracy-test1} displays the $L_1$ norm errors for the density profiles for different SPH schemes.
...
%May worthwhile to do one more test to demonstrate that if the smoothing length is constant cross the boundary, there will be no oscillation
