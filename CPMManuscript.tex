...
\begin{figure}[H]
    ...
    \begin{minipage}{.45\textwidth}
        \centering a)
        \includegraphics[width=0.99 \textwidth,height=0.7\textwidth]{./Figures/Fig2-a}
    \end{minipage}%
    \begin{minipage}{.545 \textwidth}
        \centering b)
        \includegraphics[width=0.99 \textwidth,height=0.5780 \textwidth]{./Figures/Fig2-b}
    \end{minipage}% 
    \\
    \begin{minipage}{.45 \textwidth}
        \centering c)
        \includegraphics[width=0.99 \textwidth, height=0.7\textwidth]{./Figures/Fig2-c}
    \end{minipage}% 
    \begin{minipage}{.545\textwidth}
    \centering d)
        \begin{flushleft}
        \includegraphics[width= 0.8174 \textwidth, height=0.5780 \textwidth]{./Figures/Fig2-d}    
        \end{flushleft}
    \end{minipage}%          
...
\begin{figure}[H]
    ...
    \begin{minipage}{.45\textwidth}
        \centering a)
        \includegraphics[width=0.99 \textwidth,height=0.7\textwidth]{./Figures/Fig3-a}
    \end{minipage}%
    \begin{minipage}{.545 \textwidth}
        \centering b)
        \includegraphics[width=0.99 \textwidth,height=0.5780 \textwidth]{./Figures/Fig3-b}
    \end{minipage}% 
    \\
    \begin{minipage}{.45 \textwidth}
        \centering c)
        \includegraphics[width=0.99 \textwidth, height=0.7\textwidth]{./Figures/Fig3-c}
    \end{minipage}% 
    \begin{minipage}{.545\textwidth}
    \centering d)
        \begin{flushleft}
        \includegraphics[width= 0.8174 \textwidth, height=0.5780 \textwidth]{./Figures/Fig3-d}    
        \end{flushleft}
    \end{minipage}%    
    \caption{
...
\begin{figure}[H]
    ...
    \begin{minipage}{.45\textwidth}
        \centering a)
        \includegraphics[width=0.99 \textwidth,height=0.6\textwidth]{./Figures/Fig4-a}
    \end{minipage}%
    \begin{minipage}{.545\textwidth}
    \centering b)
        \begin{flushleft}
        \includegraphics[width= 0.8174 \textwidth, height=0.4954 \textwidth]{./Figures/Fig4-b}    
        \end{flushleft}
    \end{minipage}% 
    \\
    \begin{minipage}{.45\textwidth}
        \centering c)
        \includegraphics[width=0.99 \textwidth,height=0.6\textwidth]{./Figures/Fig4-c}
    \end{minipage}%
    \begin{minipage}{.545 \textwidth}
        \centering d)
        \includegraphics[width=0.99 \textwidth,height=0.4954\textwidth]{./Figures/Fig4-d}
    \end{minipage}% 
    \\
    \begin{minipage}{.45\textwidth}
        \centering e)
        \includegraphics[width= 0.99 \textwidth, height=0.625 \textwidth]{./Figures/Fig4-e}    
    \end{minipage}%
    \begin{minipage}{.545\textwidth}
        \centering f)
        \begin{flushleft}
        \includegraphics[width= 0.8174 \textwidth, height=0.4954 \textwidth]{./Figures/Fig4-f}    
        \end{flushleft}
    \end{minipage}%  
%    \begin{minipage}{.45\textwidth}
%        \centering e)
...
\begin{figure}[H]
    ...
    \begin{minipage}{.45\textwidth}
        \centering a)
        \includegraphics[width=0.99 \textwidth,height=0.6\textwidth]{./Figures/Fig5-a}
    \end{minipage}%
    \begin{minipage}{.545\textwidth}
    \centering b)
        \begin{flushleft}
        \includegraphics[width= 0.8174 \textwidth, height=0.4954 \textwidth]{./Figures/Fig5-b}    
        \end{flushleft}
    \end{minipage}% 
    \\
    \begin{minipage}{.45\textwidth}
        \centering c)
        \includegraphics[width=0.99 \textwidth,height=0.6\textwidth]{./Figures/Fig5-c}
    \end{minipage}%
    \begin{minipage}{.545 \textwidth}
        \centering d)
        \includegraphics[width=0.99 \textwidth,height=0.4954\textwidth]{./Figures/Fig5-d}
    \end{minipage}% 
    \\
    \begin{minipage}{.45\textwidth}
        \centering e)
        \includegraphics[width=0.99 \textwidth,height=0.6\textwidth]{./Figures/Fig5-e}
    \end{minipage}%
    \begin{minipage}{.545\textwidth}
    \centering f)
        \begin{flushleft}
        \includegraphics[width= 0.8174 \textwidth, height=0.4954 \textwidth]{./Figures/Fig5-f}    
        \end{flushleft}
    \end{minipage}%  
%       \\
%    \begin{minipage}{.45 \textwidth}
...
%    \end{minipage}%
    \begin{minipage}{.70\textwidth}
        \centering
        \includegraphics[width=0.99 \textwidth]{./Figures/Fig6}
    \end{minipage}%  
...
\begin{figure}[H]
    ...
    \begin{minipage}{.415\textwidth}
        \centering
        \includegraphics[width=0.99 \textwidth]{./Figures/Fig7-a}
    \end{minipage}%
    \begin{minipage}{.512 \textwidth}
        \begin{flushleft}
        \includegraphics[width=0.8024 \textwidth]{./Figures/Fig7-b}
        \end{flushleft}
    \end{minipage}%    
    \\
    \begin{minipage}{.415\textwidth}
        \centering
        \includegraphics[width=0.99 \textwidth]{./Figures/Fig7-c}
    \end{minipage}%
    \begin{minipage}{.512 \textwidth}
        \centering
        \includegraphics[width=0.99 \textwidth]{./Figures/Fig7-d}
    \end{minipage}% 
...
\begin{figure}[H]
    ...
    \begin{minipage}{.415\textwidth}
        \centering
        \includegraphics[width=0.99 \textwidth]{./Figures/Fig8-a}
    \end{minipage}%
    \begin{minipage}{.512 \textwidth}
        \begin{flushleft}
        \includegraphics[width=0.8024 \textwidth]{./Figures/Fig8-b}
        \end{flushleft}
    \end{minipage}%     
    \\
    \begin{minipage}{.415\textwidth}
        \centering
        \includegraphics[width=0.99 \textwidth]{./Figures/Fig8-c}
    \end{minipage}%
    \begin{minipage}{.512 \textwidth}
        \centering
        \includegraphics[width=0.99 \textwidth]{./Figures/Fig8-d}
    \end{minipage}% 
...
\begin{figure}[H]
    ...
    \begin{minipage}{.415\textwidth}
        \centering
        \includegraphics[width=0.99 \textwidth]{./Figures/Fig9-a}
    \end{minipage}%
    \begin{minipage}{.512 \textwidth}
        \begin{flushleft}
        \includegraphics[width=0.8024 \textwidth]{./Figures/Fig9-b}
        \end{flushleft}
    \end{minipage}%     
    \\
    \begin{minipage}{.415\textwidth}
        \centering
        \includegraphics[width=0.99 \textwidth]{./Figures/Fig9-c}
    \end{minipage}%
    \begin{minipage}{.512 \textwidth}
        \centering
        \includegraphics[width=0.99 \textwidth]{./Figures/Fig9-d}
    \end{minipage}% 
...
\begin{figure}[H]
    \begin{minipage}{.415\textwidth}
        \centering
        \includegraphics[width=0.99 \textwidth]{./Figures/Fig10-a}
    \end{minipage}%
    \begin{minipage}{.512 \textwidth}
        \begin{flushleft}
        \includegraphics[width=0.8024 \textwidth]{./Figures/Fig10-b}
        \end{flushleft}
    \end{minipage}%       
    \\
    \begin{minipage}{.415\textwidth}
        \centering
        \includegraphics[width=0.99 \textwidth]{./Figures/Fig10-c}
    \end{minipage}%
    \begin{minipage}{.512 \textwidth}
        \centering
        \includegraphics[width=0.99 \textwidth]{./Figures/Fig10-d}
    \end{minipage}% 
...
\begin{figure}[H]
    ...
    \begin{minipage}{.415\textwidth}
        \centering
        \includegraphics[width=0.99 \textwidth]{./Figures/Fig11-a}
    \end{minipage}%
    \begin{minipage}{.512 \textwidth}
        \begin{flushleft}
        \includegraphics[width=0.8024 \textwidth]{./Figures/Fig11-b}
        \end{flushleft}
    \end{minipage}%
    \\
    \begin{minipage}{.415 \textwidth}
        \centering
        \includegraphics[width=0.99 \textwidth]{./Figures/Fig11-c}
    \end{minipage}%
    \begin{minipage}{.512 \textwidth}
        \centering
        \includegraphics[width=0.99 \textwidth]{./Figures/Fig11-d}
    \end{minipage}% 
...
\begin{figure}[H]
   \centering
   \includegraphics[width=0.95 \textwidth]{./Figures/Fig12}
...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{.325 \textwidth}
        \centering
        \includegraphics[width=0.99 \textwidth]{./Figures/Fig13-a}
    \end{minipage}%
    \begin{minipage}[t]{.325\textwidth}
        \centering
        \includegraphics[width=0.99 \textwidth]{./Figures/Fig13-b}
    \end{minipage}%
    \\
    \centering
    \begin{minipage}[t]{.325 \textwidth}
        \centering
        \includegraphics[width=0.99 \textwidth]{./Figures/Fig13-c}
    \end{minipage}%
    \begin{minipage}[t]{.325\textwidth}
        \centering
        \includegraphics[width=0.99 \textwidth]{./Figures/Fig13-d}
    \end{minipage}%
