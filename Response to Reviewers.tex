...
%We understand that the reviewer has solid background in SPH but relatively less background in mesh based CFD (computational fluid dynamics) methods. Some questions/confusion are general question for mesh based CFD. We will try to give detailed response. But we might not include these details in our revised manuscript to avoid being too disruptive.
